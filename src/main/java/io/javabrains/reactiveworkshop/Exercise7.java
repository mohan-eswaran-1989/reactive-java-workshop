...
public class Exercise7 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Print 10 multiply by each value from intNumbersFlux that's greater than 5");
        ReactiveSources.intNumbersFlux().
                filter(number -> number > 5).
        ...
        ReactiveSources.intNumbersFlux().
                filter(number -> number > 20).defaultIfEmpty(-1).subscribe(System.out::println);
